...
Creating and configuring the Axios instance
Injecting the LOTR API key into the Authorization header

Registering response interceptors for:
Network errors
...
MoviesService
QuotesService
Models (Movie, Quote, ApiResponse, QueryOptions)
